...
export const homeSec1Text = {
  ...
  card: [
    ...
    {
      title: 'Fund',
      text: "Make a deposit via any funding method you prefer to start investing in cryptocurrency and more on GENESIS EXPERTS.",
      image: blue3,
    },
    {
      title: 'Trade',
  ...
  accordions: [
    {
      ...
      text: "Go to https://www.genesis-experts.com from a browser on your computer, on Android or iOS to get started.",
    },
    {
...
export const copyright = [
  {
    text: "GENESIS EXPERTS is a fully Registered Trademark. Any trademarks appearing on this website are the property of their respective owners."
  },
  {
  ...
  {
    text: "Trading with GENESIS EXPERTS by following and/or copying or replicating the trades of other traders involves high levels of risks, even when following and/or copying or replicating the top-performing traders. Such risks include the risk that you may be following/copying the trading decisions of possibly inexperienced/unprofessional traders, or traders whose ultimate purpose or intention, or financial status may differ from yours. Before making an investment decision, you should rely on your own assessment of the person making the trading decisions and the terms of all the legal documentation."
  },
];
